# AI Agent Instructions: FFC-IN-Single_Page_Template_HTML
...
These sites deploy to `https://freeforcharity.github.io/FFC-IN-Single_Page_Template_HTML/` and optionally to a custom domain if one is configured for this repo.
