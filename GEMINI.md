# Gemini Instructions: FFC-IN-Single_Page_Template_HTML

Hey Gemini! Welcome to FFC-IN-Single_Page_Template_HTML.

**Project:** FFC-IN-Single_Page_Template_HTML -- a Free For Charity nonprofit website
...
The site deploys to `https://freeforcharity.github.io/FFC-IN-Single_Page_Template_HTML/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
